...
const userButtonModal = document.querySelector(".user-nav-button .modal-background");
const userDropdownMenu = document.querySelector(".user-nav-button ul.dropdown-menu");
